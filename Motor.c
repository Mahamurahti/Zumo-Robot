...
void motor_reverse_turn_left(uint8 l_speed, uint8 r_speed, uint32 delay)
{
    // This function is used in the maze solving
...
void motor_reverse_turn_right(uint8 l_speed, uint8 r_speed, uint32 delay)
{
    // This function is used in the maze solving
    MotorDirLeft_Write(0);      // set LeftMotor forward mode
